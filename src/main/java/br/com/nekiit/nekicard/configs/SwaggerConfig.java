package br.com.nekiit.nekicard.configs;
...
public class SwaggerConfig {
	@Value("${neki-card.swagger.dev-url}")
	...
	OpenAPI myOpenAPI() {
		...
		Info info = new Info().title("Documentação API SkillBase").version("1.0.0").contact(contact).license(license)
				.termsOfService("");
